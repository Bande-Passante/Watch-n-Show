...
<body>
  ...
  <header>
    ...
    <div id="header_right">
      <form  method="post" action="hud_watch_n_show.php"> <!-- onsubmit="connexion(this); return false;" -->
          ...
          <div class="under_box">
            <div id="contain_one">
              <div class="center">
                ...
                <div class="right_row_two">
                  <input type="texte" id="header_identifiant" placeholder="identifiant" onkeyup="name_on_key_up(this)"  name="header_identifiant" />
                </div>
            ...
            <div id="contain_two">
              <div class="center">
                ...
                <div class="right_row_two">
                  <input type="password" id="header_password" value="" placeholder="password" onkeyup="password_on_key_up(this)" name="header_password"/>
                </div>
                <div class="right_row_three">
          ...
          <div id="contain_three">
            <div class="center">
              <div class="right_row_one_btn">
                ...
                <div id="btn_valider">
                  <input class="btn_fin" type="submit" />  <!-- value="Valider" title="Connexion" -->
              </div>
  ...
  <div class="landing_row_two">
    ...
    <div class="landing_row_two_col_two">
      ...
      <form  method="post" action="traitementFormulaire.php">  <!-- onsubmit="soumettre(this); return false" -->
          ...
          <div id="column_one">
            <div class="column_one_row_one_center">
              ...
              <div class="row_with_column_one">
                ...
                <div class="col_two">
                  <input type="texte" id="name" value="" placeholder="ici doit s'écrire votre nom" onkeyup="verifPseudo(this)" name="pseudo"/>
                </div>
                <div class="col_three">
              ...
              <div class="row_with_column">
                ...
                <div class="col_two">
                  <input type="date" id="date" value="" placeholder="00/00/0000" onblur="verification_date(this)" name="birth" />
                </div>
                <div class="col_three">
              ...
              <div class="row_with_column">
                ...
                <div class="col_two">
                  <input type="texte" id="mail" value="" placeholder="E-mail" onkeyup="verifMail(this)" name="mail"/>
                </div>
                <div class="col_three">
              ...
              <div class="row_with_column">
                ...
                <div class="col_two">
                  <input type="texte" id="password" value="" onkeyup="verifMDP(this)" name="pw"/>
                </div>
                <div class="col_three">
              ...
              <div class="row_with_column">
                ...
                <div class="col_two">
                  <select id="list_select" onblur="verifSexe(this)" name="gender">
    ...
    <div id="foot_left">
      ...
      <div id="foot_left_right">
        <a href="" title="retour à l'accueil">
          ...
          <div id="users">
            <a href="user_list.html"> Ils participent déjà à l'aventure Watch'N'Show</a>
          </div>
        </a>
      </div>
    </div>
    ...
    <div id="foot_right">
      ...
      <div id="foot_right_right">
        <ul>
          ...
          <li><a href="profileDisplay.php" title="Artistes">Decouvrir des artistes</a> </li>
