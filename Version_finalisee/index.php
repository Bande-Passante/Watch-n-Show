...
<body>
  ...
  <div class="landing_row_two">
    ...
    <div class="landing_row_two_col_two">
      ...
      <form onsubmit="soumettre(this); return false;" method="post" action="index.php">
          ...
          <div id="column_one">
            <div class="column_one_row_one_center">
              ...
              <div class="row_with_column_one">
                ...
                <div class="col_two">
                  <input type="texte" id="name" name="pseudo" value="" placeholder="ici doit s'écrire votre nom" onkeyup="verifPseudo(this)"/>
                </div>
                <div class="col_three">
              ...
              <div class="row_with_column">
                ...
                <div class="col_two">
                  <input type="date" id="date" name="birth_date" value="" placeholder="00/00/0000" onblur="verification_date(this)" />
                </div>
                <div class="col_three">
              ...
              <div class="row_with_column">
                ...
                <div class="col_two">
                  <input type="texte" id="mail" name="email" value="" placeholder="E-mail" onkeyup="verifMail(this)"/>
                </div>
                <div class="col_three">
              ...
              <div class="row_with_column">
                ...
                <div class="col_two">
                  <input type="texte" id="password" name="password" value="" onkeyup="verifMDP(this)"/>
                </div>
                <div class="col_three">
              ...
              <div class="row_with_column">
                ...
                <div class="col_two">
                  <input type="texte" id="password_confirm" name="password_confirm" value="" onkeyup="verifConfiMDP(this)"/>
              ...
              <div class="row_with_column">
                ...
                <div class="col_two">
                  <select id="list_select" name="sexe" onblur="verifSexe(this)">
